...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addComment(XmlElement xmlElement) {
        if (suppressAllComments || suppressXmlComments) {
            return;
        }
    ...
    public void addConfigurationProperties(Properties props) {
        ...
        suppressXmlComments = isTrue(properties.getProperty(PropertyRegistry.COMMENT_GENERATOR_SUPPRESS_XML_COMMENTS), true);
