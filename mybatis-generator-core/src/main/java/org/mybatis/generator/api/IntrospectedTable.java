...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setCountByExampleStatementId(fillExampleKey("countByExample")); //$NON-NLS-1$
        setDeleteByExampleStatementId(fillExampleKey("deleteByExample")); //$NON-NLS-1$
        setDeleteByPrimaryKeyStatementId("deleteByPrimaryKey"); //$NON-NLS-1$
        setInsertStatementId("insert"); //$NON-NLS-1$
        setInsertSelectiveStatementId("insertSelective"); //$NON-NLS-1$
        setSelectAllStatementId("selectAll"); //$NON-NLS-1$
        setSelectByExampleStatementId(fillExampleKey("selectByExample")); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId(fillExampleKey("selectByExampleWithBLOBs")); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId("selectByPrimaryKey"); //$NON-NLS-1$
        setUpdateByExampleStatementId(fillExampleKey("updateByExample")); //$NON-NLS-1$
        setUpdateByExampleSelectiveStatementId(fillExampleKey("updateByExampleSelective")); //$NON-NLS-1$
        setUpdateByExampleWithBLOBsStatementId(fillExampleKey("updateByExampleWithBLOBs")); //$NON-NLS-1$
        ...
        setExampleWhereClauseId(fillExampleKey("Example_Where_Clause")); //$NON-NLS-1$
        setBaseColumnListId("Base_Column_List"); //$NON-NLS-1$
        setBlobColumnListId("Blob_Column_List"); //$NON-NLS-1$
        setMyBatis3UpdateByExampleWhereClauseId(fillExampleKey("Update_By_Example_Where_Clause")); //$NON-NLS-1$
    }

    private String fillExampleKey(String countByExample) {
        return countByExample.replace("Example", context.getExampleKey());
    }
    ...
    protected void calculateJavaClientAttributes() {
        ...
        if (stringHasValue(tableConfiguration.getMapperName())) {
            ...
            sb.append(context.getMapperSuffix()); //$NON-NLS-1$
        }
    ...
    protected void calculateModelAttributes() {
        ...
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append(context.getExampleKey()); //$NON-NLS-1$
    ...
    protected String calculateMyBatis3XmlMapperFileName() {
        ...
        if (stringHasValue(tableConfiguration.getMapperName())) {
            ...
            sb.append(fullyQualifiedTable.getDomainObjectName());
            sb.append(context.getMapperSuffix() + ".xml"); //$NON-NLS-1$
        }
        return sb.toString();
    }
