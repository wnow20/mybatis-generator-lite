...
public class IgnoredColumn {
    ...
    /**
     * If true then MBG will perform a case-sensitive exact match when matching against returned columns from the
     * database. If false (default) then the name is considered case-insensitive.
     */
