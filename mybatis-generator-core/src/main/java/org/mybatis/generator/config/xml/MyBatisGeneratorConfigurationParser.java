...
public class MyBatisGeneratorConfigurationParser {
    ...
    private void parseContext(Configuration configuration, Node node) {
        ...
        String exampleKey = attributes.getProperty("exampleKey");
        String mapperSuffix = attributes.getProperty("mapperSuffix");
        String enablePage = attributes.getProperty("enablePage");
        ...
        if (stringHasValue(exampleKey)) {
            context.setExampleKey(exampleKey);
        }
        if (stringHasValue(mapperSuffix)) {
            context.setMapperSuffix(mapperSuffix);
        }
        if (stringHasValue(enablePage)) {
            context.setEnablePage(Boolean.parseBoolean(enablePage));
        }
