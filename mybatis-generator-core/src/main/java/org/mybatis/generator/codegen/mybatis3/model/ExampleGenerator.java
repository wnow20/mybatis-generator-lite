...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        if (context.getEnablePage()) {
            ...
            method.addParameter(new Parameter(FullyQualifiedJavaType.getIntegerInstance(), "pageIndex"));
            method.addParameter(new Parameter(FullyQualifiedJavaType.getIntegerInstance(), "pageSize"));
            method.setVisibility(JavaVisibility.PUBLIC);
            method.addBodyLine("offset = Math.max(pageIndex - 1, 0) * pageSize;");
            method.addBodyLine("rows = pageSize;");
            topLevelClass.addMethod(method);
        }
